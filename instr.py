...
txt_instr_2_edit = '0'
txt_instr_3_edit = '0'
txt_result = 'Индекс Руфье:'
txt_rec = 'Работоспособность сердца:'
txt_res_1 = 'низкая. Срочно обратитесь к врачу!'
txt_res_2 = 'удовлетворительная. Обратитесь к врачу!'
txt_res_3 = 'средняя. Возможно стоит дополнительно обследоваться у врача!'
txt_res_4 = 'выше среднего. Пейте больше воды и занимайтесь спортом!'
txt_res_5 = 'высокая. Вы супер, пробегите марафон!'
